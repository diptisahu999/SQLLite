...
class Bms_item_details(models.Model):
    ...
    category_id=models.ForeignKey(Bms_inventory_category,on_delete=models.CASCADE,related_name='items')
...
class Bms_manage_inventory_stock(models.Model):
    item_id=models.ForeignKey(Bms_item_details, related_name='manage_stock',on_delete=models.CASCADE)
