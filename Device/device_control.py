        ...
        for i in d_list:
            if i["device_type"] == "LED":
                ...
                if i['device_status'] == "true":
                    ...
                    param = {
                        {"device_id": int(i.get('device_id')),
                         "channel_id": int(i.get('channel_id')),
                         "ac_temp": int(i.get('ac_temp')),
                         "rm_temp": int(i.get('rm_temp')),
                         "mode": str(i.get("mode")),
                         "swing": str(i.get("mode")),
                         "fspeed": str(i.get("fspeed")),
                         "device_status":str(i.get("device_status"))}
                    }
# {"device_id": "92", "channel_id": "1", "ac_temp": "25", "rm_temp": "34", "mode": "F", "swing": "", "fspeed": "L", "device_status": "true"}
                print("I am AC")
